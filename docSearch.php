...
<div class="container-fluid">
    <div class="jumbotron text-center"style ="background-color:#a8c7cb">
            <h1 class="display-4">SEARCH DOCTOR</h1>
            <p class="lead">Please enter doctor email</p>
            <hr class="my-4">
            </div>
    </div>
    <body>
    <div class="container">
        ...
        <form role="form" method="POST" action="docSearch.php" value ="">
        <div class="row">
        <div class="col-sm-12">
...
$query = "SELECT first_name,last_name,email,doctor_id FROM doctor where email ='$_POST[search_for]'";
