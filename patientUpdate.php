...
<th scope="row">1</th>
      ...
      <td><a href="patientUpdate.php?edit=<?php echo $row['patient_id'];?>">EDIT</a></td>
      <td><a href="patientUpdate.php?del=<?php echo $row['patient_id'];?>">DELETE</a></td>
    </tr>
...
<form class="mx-auto" style="padding:20px;width: 70em;" action ='PatientUpdate.php'method='POST'>
...
<div class="text-center"> <button type="submit"  href= "patientUpdate.php"name = "save" style ="background-color:#a8c7cb;color:white;" class="btn">Return</button></div>
